...
int main(){
    ...
    cout<<"Enter the element to be searched in the BST: ";
    int val=0;
    cin>>val;
    if(SearchBST(n1 , val)==1){
        cout<<"Element "<<val<<" found in this BST"<<endl;
    }
    else{
        cout<<"Element "<<val<<" NOT found in this BST"<<endl;
    }
return 0;
}